...
def main():
    ...
    # Memory optimization: limit frames based on available GPU memory
    max_frames = 32  # Start with fewer frames for memory optimization
    ...
    try:
        ...
        output_path = os.path.join(RESULT_ROOT, f"FlashVSR_optimized_elk_seed{seed}.mp4")
